    ...
    axios
      .post(
        `${domain}/api/user/updateNotifications`,
        {
          ...
          hiresMe: notifications.hiresMe,
          followsMe: notifications.followMe,
          commentsMe: notifications.comments,
          messageAlerts: notifications.messages,
          jobNotifications: notifications.jobNotifications,
        },
        config
      )
      .then((res) => {
        ...
        axios.get(`${domain}/api/user/getUserData`, config).then((res) => {
          ...
          setNotifications({
            ...
            hiresMe: res.data.hiresMe,
            followMe: res.data.followsMe,
            comments: res.data.commentsMe,
            messages: res.data.messageAlerts,
      ...
      <div>
        <div style={{ marginBottom: "10px" }}>
          <input
            type="checkbox"
            disabled={!edit}
            checked={notifications.hiresMe}
            id="hiresMe"
            onChange={changeHandler}
          />
          <label className="inputLabel ml15" htmlFor="hiresMe">
            Anyone hires me
          </label>
        </div>
        <hr className={DashCss.pdHr} />
        <div style={{ marginBottom: "10px" }}>
          <input
            type="checkbox"
            disabled={!edit}
            checked={notifications.followMe}
            id="followMe"
            onChange={changeHandler}
          />
          <label className="inputLabel ml15" htmlFor="followMe">
            Anyone follows me
          </label>
        </div>
        <hr className={DashCss.pdHr} />
        <div style={{ marginBottom: "10px" }}>
          <input
            ...
            onChange={changeHandler}
          />
          <label className="inputLabel ml15" htmlFor="comments">
            Someone comments on my shots
          </label>
        </div>
        <hr className={DashCss.pdHr} />
        <div style={{ marginBottom: "10px" }}>
          <input
            ...
            onChange={changeHandler}
          />
          <label className="inputLabel ml15" htmlFor="jobNotifications">
        ...
        <div style={{ marginBottom: "10px" }}>
          <input
            ...
            onChange={changeHandler}
          />
          <label className="inputLabel ml15" htmlFor="messages">
            Someone messages me
          </label>
        </div>
        <hr className={DashCss.pdHr} />
...
Notifications.Layout = PilotAccount;
