...
function Downloads() {
  ...
  return (
    <div>
      ...
      <Alert severity="info">No Downloaded {selectedTab} <Link href = "/"><a style = {{textDecoration: "underline"}}>Browse</a></Link> now</Alert>
      </div>
                ...
                {item.fileType !== "video" ? (
                  ...
                  <a target="_blank">
                    <Image
                      ...
                      src={`${imageLink}/400x360/${item.file}`}
...
Downloads.Layout = PilotActivities;
